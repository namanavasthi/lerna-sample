import { AnyFunction } from "@namanavasthi/utils";
...
const toGroup = (fn: AnyFunction) => merge((v) => fn(v, "&"), "[role=group]", "[data-group]", ".group");
...
export const pseudoSelectors = {
   ...
   */
  _dark: ".platform-ui-dark &:not([data-theme])," + "[data-theme=dark] &:not([data-theme])," + "&[data-theme=dark]",
  /**
   * Styles for when `data-theme` is applied to any parent of
   * this component or element.
   */
  _light: ".platform-ui-light &:not([data-theme])," + "[data-theme=light] &:not([data-theme])," + "&[data-theme=light]",
};
